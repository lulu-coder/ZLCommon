...
@implementation UIImage (ZLEffects)
...
+ (UIImage *)imageWithView:(UIView *)view{
    ...
    UIColor *tintColor = [UIColor colorWithWhite:0.95 alpha:0.5];
    image = [image zl_applyBlurWithRadius:15 tintColor:tintColor saturationDeltaFactor:1 maskImage:nil];
    UIGraphicsEndImageContext();
